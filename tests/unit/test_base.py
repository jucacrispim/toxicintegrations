# -*- coding: utf-8 -*-
# Copyright 2019, 2023, 2024 Juca Crispim <juca@poraodojuca.dev>
...
from toxiccore.utils import localtime2utc
from toxicintegrations import base
...
@patch('toxiccommon.client.HoleClient.connect',
       AsyncMock())
@patch('toxiccommon.client.HoleClient.request2server',
       AsyncMock(return_value={'id': 'asdf'}))
@patch('toxiccommon.client.HoleClient.is_connected', MagicMock(
    return_value=True))
@patch('toxiccommon.client.HoleClient.__exit__', MagicMock())
@patch('toxiccommon.interfaces.get_hole_client_settings',
